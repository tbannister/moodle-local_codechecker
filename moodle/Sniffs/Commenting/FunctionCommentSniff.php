 ...
 */
$requiredclass = 'PHP_CodeSniffer_CommentParser_FunctionCommentParser';
...
class moodle_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff {
    ...
    public function process(PHP_CodeSniffer_File $phpcsfile, $stackptr) {
        ...
        $commentsize = $commentend - $commentstart + 1;
        $comment     = $phpcsfile->gettokensAsString($commentstart, $commentsize);
        ...
        if (empty($long) === false) {
            ...
            if ($newlinebetween !== 2) {
                $error = 'There must be exactly one blank line between'
                       .' descriptions in function comment';
    ...
    protected function processreturn($commentstart, $commentend) {
        ...
        $isconstruct     = ($this->_methodname === '__construct');
        $isspecialmethod = ($isconstruct || $this->_methodname === '__destruct');
    ...
    protected function processparams($commentstart) {
        ...
        if (empty($params) === false) {
            ...
            $lastwhitespace = $params[$lastparm]->getwhitespaceafter();
            ...
            foreach ($params as $param) {
                ...
                if ($paramcomment === '') {
                    $error = 'Missing comment for param "'.$paramname
                           .'" at position '.$pos;
                    $this->currentfile->adderror($error, $errorpos);
                }
