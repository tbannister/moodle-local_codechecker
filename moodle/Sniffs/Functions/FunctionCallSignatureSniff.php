...
class moodle_Sniffs_Functions_FunctionCallSignatureSniff implements PHP_CodeSniffer_Sniff {
    ...
    public function process(PHP_CodeSniffer_File $phpcsfile, $stackptr) {
        ...
        $next = $phpcsfile->findnext($emptytokens, ($stackptr + 1), null, true);
        ...
        $previous = $phpcsfile->findprevious($emptytokens, ($stackptr - 1), null, true);
        ...
        if ($tokens[$next]['code'] === T_SEMICOLON) {
            ...
            if (in_array($tokens[($closer + 1)]['code'], $emptytokens) === true) {
